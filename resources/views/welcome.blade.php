                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                {{ $settings['contact_address'] ?? 'No configurado' }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Central: {{ $settings['contact_phone'] ?? 'No configurado' }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900">Correo Electrónico</h4>
                            <p class="text-gray-600">
                                {{ $settings['contact_email'] ?? 'No configurado' }}
                            </p>
                        </div>
                    </div>
